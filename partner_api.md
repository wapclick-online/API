...
#### 2.1.4 Перенаправление абонента
...
Система поддерживает UTM метки. Для их использования нужно передавать параметры в запросе инициации подписки (п. 2.1.1). Метки будут доступны для выборки в личном кабинете.
