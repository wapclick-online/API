...
Подписки – предоставление абоненту доступа к контенту. Абонент соглашается на подписку на странице оператора связи (landing page). Оператор связи списывает деньги с абонента, уведомляет о списании. Списание денег и предоставление доступа прекращается при выполнении одного из следующих условий - отписался абонент, закончился срок подписки, нет денег у абонента. Тарификация подписавшегося абонента происходит каждый день.
...
## 3. Дополнительные параметры кода загрузки скрипта

Если требуется предоставлять абоненту несколько видов контента или требуется большая безопасность взаимодействия, то возможно задавать дополнительные параметры при загрузке скрипта
